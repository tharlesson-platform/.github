...
| `terraform-import` | Terraform Import (sync) | Copia sincronizada do fluxo de importacao para Terraform. | [tharlesson/terraform-import](https://github.com/tharlesson/terraform-import) |
